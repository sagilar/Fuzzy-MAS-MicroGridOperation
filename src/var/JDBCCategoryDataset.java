...
public class JDBCCategoryDataset extends DefaultCategoryDataset {
     ...
     * using data obtained with the supplied results.
     *
     ...
     */
    public JDBCCategoryDataset(Connection connection, ResultSet results) throws SQLException {
        this(connection);
    ...
    /**
     * Populates the dataset using data presented to it in the ResultSet object.
