...
public class JDBCPieDataset extends DefaultPieDataset {
    ...
    /**
     * Creates a new JDBCPieDataset using a pre-existing result set.
     * <P>
     * The dataset is initialised with data from the supplied results.
     *
     * @param con  the database connection.
     * @param results  results of an SQL query.
     *
     * @throws SQLException if there is a problem reading the results.
     */
    public JDBCPieDataset(Connection con, ResultSet results) throws SQLException {
        this(con);
    ...
    /**
     * setResultSet extracts data presented to it in the ResultSet object,
     * which should have exactly two columns.
     * @param  resultSet a valid ResultSet containing the data.
     * @throws SQLException if there is a problem reading the results.
     */
