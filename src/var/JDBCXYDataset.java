...
public class JDBCXYDataset extends AbstractXYDataset 
    ...
    /**
     * Creates a new dataset with the given database connection, and uses the 
     * given resultset to populate the dataset.
     *
     ...
     */
    public JDBCXYDataset(Connection connection, ResultSet results) 
        throws SQLException {
        this(connection);
